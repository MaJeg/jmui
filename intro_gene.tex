...
%Moreover, these limitations come from the perceive-decide-act paradigm used in these models: agents make punctual decisions about how to behave regarding turn-taking after having gathered sufficient informations about the user's behavior. It results in long response latencies of the agent and poor abilities to repair conflicting situations. 
